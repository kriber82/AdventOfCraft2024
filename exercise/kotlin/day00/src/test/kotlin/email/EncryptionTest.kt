...
class EncryptionTest : StringSpec({
    ...
    "should decrypt the email" {
        val encryptedMailContent = loadFile("EncryptedEmail.txt")
        val mailContent = encryption.decrypt(encryptedMailContent)
        mailContent shouldBe """Dear consultant,
